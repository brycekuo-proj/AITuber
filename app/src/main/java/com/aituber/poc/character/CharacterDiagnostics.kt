...
object CharacterDiagnostics {
    ...
    fun recordStaticPngBreathMotion(
        ...
        chestEnabled: Boolean = false,
        chestVisible: Boolean = false,
        chestAssetPath: String = "n/a",
        chestActiveState: String = "UNKNOWN",
        chestDisabledReason: String = "n/a",
        ...
        chestOverlayBounds: String = "n/a",
        chestLayerType: String = "n/a",
        chestCompensationFactor: Float = 1f,
        chestEffectiveScaleX: Float = 1f,
        chestEffectiveScaleY: Float = 1f,
        chestPeakPixelDelta: Float = 0f,
        chestCurrentPixelDelta: Float = 0f,
        chestDisplayScale: Float = 0f
    ) {
        current = current.copy(
            ...
            staticPngChestPieceEnabled = if (chestEnabled) "YES" else "NO",
            staticPngChestPieceVisible = if (chestVisible) "YES" else "NO",
            staticPngChestPieceAssetPath = chestAssetPath,
            staticPngChestPieceActiveState = chestActiveState,
            staticPngChestPieceDisabledReason = chestDisabledReason,
            ...
            staticPngChestBreathOverlayBounds = chestOverlayBounds,
            staticPngChestBreathLayerType = chestLayerType,
            staticPngChestBreathCompensationFactor = chestCompensationFactor.toDouble(),
            staticPngChestBreathEffectiveScaleX = chestEffectiveScaleX.toDouble(),
            staticPngChestBreathEffectiveScaleY = chestEffectiveScaleY.toDouble(),
            staticPngChestBreathPeakPixelDelta = chestPeakPixelDelta.toDouble(),
            staticPngChestBreathCurrentPixelDelta = chestCurrentPixelDelta.toDouble(),
            staticPngChestBreathDisplayScale = chestDisplayScale.toDouble()
        )
    }
    ...
    fun recordStaticPngThinking(
        ...
        current = current.copy(
            ...
            staticPngThinkingFrameHoldMs = frameHoldMs,
...
data class CharacterDiagnosticsSnapshot(
    ...
    val staticPngChestPieceEnabled: String,
    val staticPngChestPieceVisible: String,
    val staticPngChestPieceAssetPath: String,
    val staticPngChestPieceActiveState: String,
    val staticPngChestPieceDisabledReason: String,
    ...
    val staticPngChestBreathOverlayBounds: String,
    val staticPngChestBreathLayerType: String,
    val staticPngChestBreathCompensationFactor: Double,
    val staticPngChestBreathEffectiveScaleX: Double,
    val staticPngChestBreathEffectiveScaleY: Double,
    val staticPngChestBreathPeakPixelDelta: Double,
    val staticPngChestBreathCurrentPixelDelta: Double,
    val staticPngChestBreathDisplayScale: Double,
    ...
    val staticPngThinkingFrameHoldMs: Long,
    ...
    companion object {
        fun empty() = CharacterDiagnosticsSnapshot(
            ...
            staticPngBreathPeriodMs = 4_525L,
            staticPngBreathPivotX = 0.0,
            staticPngBreathPivotY = 0.0,
            staticPngChestBreathActive = "NO",
            staticPngChestBreathAmplitudePercent = 55,
            staticPngChestBreathPhase = 0.0,
            staticPngChestBreathInhale = 0.0,
            staticPngChestPieceEnabled = "NO",
            staticPngChestPieceVisible = "NO",
            staticPngChestPieceAssetPath = "n/a",
            staticPngChestPieceActiveState = "UNKNOWN",
            staticPngChestPieceDisabledReason = "n/a",
            ...
            staticPngChestBreathOverlayBounds = "n/a",
            staticPngChestBreathLayerType = "n/a",
            staticPngChestBreathCompensationFactor = 1.0,
            staticPngChestBreathEffectiveScaleX = 1.0,
            staticPngChestBreathEffectiveScaleY = 1.0,
            staticPngChestBreathPeakPixelDelta = 0.0,
            staticPngChestBreathCurrentPixelDelta = 0.0,
            staticPngChestBreathDisplayScale = 0.0,
