...
object CharacterDiagnostics {
    ...
    fun recordStaticPngBreathMotion(
        ...
        chestAmplitudePercent: Int = 0,
        chestPhase: Float = 0f,
        chestInhale: Float = 0f,
        chestSourceBounds: String = "n/a",
        chestSourceNormalizedBounds: String = "n/a",
        chestViewBounds: String = "n/a",
        chestScaleX: Float = 1f,
        chestScaleY: Float = 1f,
        chestOffsetY: Float = 0f,
        chestLocalTransform: String = "n/a"
    ) {
        current = current.copy(
            ...
            staticPngChestBreathActive = if (chestActive) "YES" else "NO",
            staticPngChestBreathAmplitudePercent = chestAmplitudePercent,
            staticPngChestBreathPhase = chestPhase.toDouble(),
            staticPngChestBreathInhale = chestInhale.toDouble(),
            staticPngChestBreathSourceBounds = chestSourceBounds,
            staticPngChestBreathSourceNormalizedBounds = chestSourceNormalizedBounds,
            staticPngChestBreathViewBounds = chestViewBounds,
            staticPngChestBreathScaleX = chestScaleX.toDouble(),
            staticPngChestBreathScaleY = chestScaleY.toDouble(),
            staticPngChestBreathOffsetY = chestOffsetY.toDouble(),
            staticPngChestBreathLocalTransform = chestLocalTransform
        )
    }
    ...
    fun recordStaticPngHairLayer(
        ...
        transitionTo: String,
        transitionPipelineTriggered: Boolean,
        ...
        current = current.copy(
            ...
            staticPngHairTransitionFrom = transitionFrom,
            staticPngHairTransitionTo = transitionTo,
            staticPngHairTransitionPipelineTriggered = if (transitionPipelineTriggered) "YES" else "NO",
            staticPngHairTransitionDurationMs = transitionDurationMs,
...
data class CharacterDiagnosticsSnapshot(
    ...
    val staticPngChestBreathActive: String,
    val staticPngChestBreathAmplitudePercent: Int,
    val staticPngChestBreathPhase: Double,
    val staticPngChestBreathInhale: Double,
    val staticPngChestBreathSourceBounds: String,
    val staticPngChestBreathSourceNormalizedBounds: String,
    val staticPngChestBreathViewBounds: String,
    val staticPngChestBreathScaleX: Double,
    val staticPngChestBreathScaleY: Double,
    val staticPngChestBreathOffsetY: Double,
    val staticPngChestBreathLocalTransform: String,
    ...
    val staticPngHairTransitionFrom: String,
    val staticPngHairTransitionTo: String,
    val staticPngHairTransitionPipelineTriggered: String,
    val staticPngHairTransitionDurationMs: Long,
    ...
    companion object {
        fun empty() = CharacterDiagnosticsSnapshot(
            ...
            staticPngBreathAmplitudePercent = 0,
            staticPngBreathPeriodMs = 4_800L,
            staticPngBreathPivotX = 0.0,
            staticPngBreathPivotY = 0.0,
            staticPngChestBreathActive = "NO",
            staticPngChestBreathAmplitudePercent = 50,
            staticPngChestBreathPhase = 0.0,
            staticPngChestBreathInhale = 0.0,
            staticPngChestBreathSourceBounds = "n/a",
            staticPngChestBreathSourceNormalizedBounds = "n/a",
            staticPngChestBreathViewBounds = "n/a",
            staticPngChestBreathScaleX = 1.0,
            staticPngChestBreathScaleY = 1.0,
            staticPngChestBreathOffsetY = 0.0,
            staticPngChestBreathLocalTransform = "n/a",
            ...
            staticPngHairTransitionFrom = "BASE",
            staticPngHairTransitionTo = "BASE",
            staticPngHairTransitionPipelineTriggered = "NO",
            staticPngHairTransitionDurationMs = 0L,
