        ...
        val XianxiaFemale = StaticPngCharacterPackage(
            ...
            hairLayers = mapOf(
                StaticPngHairShape.FLOAT_A to StaticPngHairLayer(
                    assetPath = "characters/xianxia_female/static/xianxia_female__hair__float_a__replacement__v5.png"
                ),
                StaticPngHairShape.FLOAT_B to StaticPngHairLayer(
                    assetPath = "characters/xianxia_female/static/xianxia_female__hair__float_b__replacement__v5.png"
                )
            )
        )
    }
